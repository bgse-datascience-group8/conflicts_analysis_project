...
```{r}
library(R.utils)
# Do this analysis on log vs stdzed data is much much different in terms of fit.
# If you use log_num_conflicts instead you can get r-squareds of 0.5+ (0.71 for Washington D.C.)
# so it seems the initial assumption of non-stationarity was wrong wrong
